...
/**
 * Strings for the category admin tool
 *
 * @package    tool_cat
...
$string['pluginname'] = 'Category admin tool';
$string['plugindesc'] = 'The category admin tool allows mass-administration of categories and the courses within them.';
